...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className, textClassName, hoverSize = 300 }: MagneticTextProps) {
  ...
  return (
    ...
    >
      ...
      <span className={cn("text-5xl font-bold tracking-tighter text-foreground block", textClassName)}>{text}</span>
      ...
      >
        ...
        >
          <span className={cn("text-5xl font-bold tracking-tighter text-background whitespace-nowrap", textClassName)}>
            {hoverText}
          </span>
        </div>
      </div>
